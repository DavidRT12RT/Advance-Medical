...
import { setDetalleDeCompra, setDetalleDeVenta, setOpenDrawer, setTotalDeLaCompra } from '@/features/finanzasSlice';
// import FormVentas from '@/components/finanzas/ventas/FormVentas';
// import SearchVentas from '@/components/finanzas/ventas/SearchVentas';
// import TableVentas from '@/components/finanzas/ventas/TableVentas';
...
import SearchCXP from '@/components/finanzas/cuentas-por-pagar/SearchCXP';
import TableCXP from '@/components/finanzas/cuentas-por-pagar/TableCXP';
...
const page = () => {
  ...
  const { detalleDeVenta, openDrawer, idNuevoProveedor } = useSelector((state: any) => state.finanzas);
  ...
  return (
    <div>
        ...
        <Row justify="space-between" align="middle" gutter={[16, 16]}>
          <Col>
            <Space>
              ...
              <Col>
                <Title level={4} style={{ marginBottom: '0px' }}>Cuentas por pagar</Title>
              </Col>
            </Space>
          </Col>
          <Col>
      ...
      <Drawer
        title={detalleDeVenta?.id ? 'Editar cuenta por pagar' : 'Nueva cuenta por pagar'}
        width={868}
