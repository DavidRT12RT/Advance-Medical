...
import SkeletonCatalogos from "@/components/inventario/catalogos/SkeletonCatalogos";
import {
  DeleteOutlined,
  FormOutlined,
  MoreOutlined,
...
const TableListaArticulosUnidad = ({ form }: any) => {
...
export default TableListaArticulosUnidad;
